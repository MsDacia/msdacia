...
3. Do more advance animations with CSS3
4. Learn React, Redux (WIP)
5. ~~Learn Vue2~~
6. ~~Learn TypeScript~~
7. ~~Learn Firebase~~
8. ~~Learn e2e and unit tests~~
9. Maybe...and a strong maybe to learn a backend technology like Scala, Go, or Ruby on Rails
