<template>
	<footer>
		<div class="mobile-only ui two column centered grid">
		...
		<div class="desktop-only ui one column centered grid">
		...
		<h2 class="lead" @click="open">{{content.common.global.title}}</h2>
		<p class="copyright">
