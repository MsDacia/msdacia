...
?> -->
			...
			<div class="contentBlock">
				<div data-role="collapsible">
					<h4>Development</h4>
					<p><strong><em>Front-End:</em></strong> HTML5, CSS3 (LESS, SASS), XML, JSON, YAML, Twig<br />
					<strong><em>JavaScript:</em></strong> jQuery, AJAX, Node, Grunt, Gulp, Bower, Bootstrap, AngularJS, VueJS<br />
					<strong><em>Coding Environment/CMS:</em></strong> Java, PHP, SQL, WordPress, Craft CMS, Squarespace, Hybris, Adobe CQ/AEM, Squarespace</p>
				</div>
			...
			<div class="contentBlock">
				<div data-role="collapsible-set">
					<div data-role="collapsible">
						<h4>Applications Developer<span>, 03/2017 to present</span></h4>
						<p><strong><em>Innerworkings</em></strong>, Chicago, Illinois</p>

						<ul>
								<li>Developing web-based application for B2B clients using HTML5, CSS3, JavaScript, AngularJS, and Java</li>
								<li>Debugging defects in application environment, including SQL scripts, API callback</li>
								<li>Generating on-demand PDFs from application based on user’s requirements</li>
						</ul>
					</div>

					<div data-role="collapsible">
						<h4>Web Developer (Independent Contractor)<span>, 02/2004 to present</span></h4>
						<p>Chicago, Illinois</p>

						<ul>
								<li>Developing websites and applications for various clients with a need for short-term, one-off developers</li>
								<li>Working on a variety of projects that could include responsive web design using technologies including but not limited to AJAX, JavaScript (jquery, Bootstrap, and AngularJS), XML, API, and JSON/Twig within JSX React templates, while working efficiently with a strong attention to detail and accuracy from Invision and Sketch mockups</li>
								<li>Participating in daily stand-up meetings, sprint planning meetings, and retrospective via Google Hangouts</li>
								...
								<li>Executing cross-browser QA testing/debugging along with web standards and ensuring accessibility and W3C compliance</li>
								<li>Producing web assets, by slicing and editing images in Photoshop/Sketch/Zeplin and page layou</li>
								<li>Utilizing experience and judgment to plan around milestone schedules in order to manage multiple deadline driven projects</li>
								<li>Monitoring status and progress of websites with Google Analytics and fixed server- and client-side errors generated</li>
								<li>Testing website for functionality for cross-browser and cross-platform issues and enforced coding W3C standards</li>
						</ul>
					</div>
					...
					<div data-role="collapsible">
						...
						<ul>
								<li>Created all coded presentation layer deliverables utilizing HTML5, JavaScript, CSS3, Backbone, SASS, JSON within Adobe AEM/CQ and Hybris</li>
								<li>Converted HTML pages from Sketch/Zeplin to microsites and landing pages for clients</li>
								<li>Worked within agile, SCRUM-based environment on large commerce accounts</li>
								<li>Architected client sites using Grunt/Gulp, setting up project framework and developing single-page applications using AWS</li>
						</ul>
					</div>
					...
					<div data-role="collapsible">
						...
						<ul>
								<li>Produced HTML5/CSS page templates from master source documents for desktop and mobile web applications using technologies including CSS3, HTML, AJAX, JavaScript, backbone.js, XML/XSLT, JSP, API, JSON, and ATG CMS</li>
								...
								<li>Handled the deployment process for the end of sprint code release to production, along with documentation of our process</li>
						</ul>
					</div>

					<div data-role="collapsible">
						<h4>Senior Front-End Web Developer<span>, 06/2008 to 12/2013</span></h4>
						...
						<ul>
							...
							<li>Architected and developed front-end sites and applications, including responsive web design, JavaScript (both jQuery and dojo frameworks), RESTful API integration, and rich media production and social media integration while working efficiently with a strong attention to detail and accuracy</li>
							<li>Provided appropriate guidance and oversight to team members to ensure quality of deliverables, mentoring college hires</li>
							<li>Provided estimates on project deliverables based on level of effort, resources, and requirements</li>
						</ul>
					</div>
